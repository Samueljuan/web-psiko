...
if (isset($_SESSION["adminuid"])) {
         ...
         echo "<a class='navbar-brand' href='#'>Selamat Datang " . $_SESSION["adminuid"] . " !</a>";
   ...
   echo '<div class="row no-gutters mt-5">';
      echo '<div class="col-md-2 bg-dark mt-2 pr-3 pt-4">';
         echo '<ul class="nav flex-column ml-3">';
            ...
            echo '</li>';
            echo '<li class="nav-item">';
               echo '<a class="nav-link text-white" href="list-dosen.php"><i class="fas fa-chalkboard-teacher mr-2"></i>List Dosen</a>';
               echo '<hr class="bg-secondary">';
            echo '</li>';
            echo '<li class="nav-item">';
            ...
            echo '</li>';
            echo '<li class="nav-item">';
               echo '<a class="nav-link text-white" href="daftar.php"><i class="fas fa-users mr-2"></i>Daftar Dosen</a>';
               echo '<hr class="bg-secondary">';
            echo '</li>';
            echo '<li class="nav-item">';
               echo '<a class="nav-link text-white" href="daftar-admin.php"><i class="fas fa-user-tie mr-2"></i>Daftar Admin</a>';
               echo '<hr class="bg-secondary">';
            echo '</li>';
            echo '<li class="nav-item">';
               echo '<a class="nav-link text-white" href="hapus-dosen.php"><i class="fas fa-user-tie mr-2"></i>Hapus Dosen</a>';
               echo '<hr class="bg-secondary">';
            echo '</li>';
            echo '<li class="nav-item">';
               echo '<a class="nav-link text-white" href="hapus-admin.php"><i class="fas fa-user-tie mr-2"></i>Hapus Admin</a>';
               echo '<hr class="bg-secondary">';
            echo '</li>';
         echo '</ul>';
      echo '</div>';
